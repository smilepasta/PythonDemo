...
class Weibo:
    cookie = {"Cookie": "_T_WM=caad0ff3fffc9d33e0d7f4b924c88ecf; WEIBOCN_FROM=1110006030; MLOGIN=0; M_WEIBOCN_PARAMS=uicode%3D10000011%26fid%3D102803; SUB=_2A252i-LsDeRhGeVI4loR9ibPzTyIHXVSd46krDV6PUJbkdAKLULNkW1NTBVlBRnwbyK_hFOxp2kVUp-R2_cXxoH1; SUHB=0rr7tv5wNYXFgg; SCF=AoVqPxC_oceCbyW8LxrlQ-L-yg3lhdfMyWkY4hjgWzFejTEIBr7dik6CplRwBVLHgqnRO_4WzDv2mB5gCT4qFEM.; SSOLoginState=1536135868"}  # 将your cookie替换成自己的cookie
...
def main():
    try:
        ...
        user_id = 2165504093  # 可以改成任意合法的用户id（爬虫的微博id除外）
